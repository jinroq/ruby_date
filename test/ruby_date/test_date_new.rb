...
class RubyDateDateNewTest < Test::Unit::TestCase
  ...
  def test_invalid_types
    ...
    assert_raise(TypeError) { RubyDate.jd(o) }
    assert_raise(TypeError) { RubyDate.jd(1, o) }
    assert_raise(TypeError) { RubyDate.jd(1, 1, o) }
    assert_raise(TypeError) { RubyDate.jd(1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.new(o) }
    assert_raise(TypeError) { RubyDate.new(1, o) }
    assert_raise(TypeError) { RubyDate.new(1, 1, o) }
    assert_raise(TypeError) { RubyDate.new(1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.new(1, 1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.new(1, 1, 1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.ordinal(o) }
    assert_raise(TypeError) { RubyDate.ordinal(1, o) }
    assert_raise(TypeError) { RubyDate.ordinal(1, 1, o) }
    assert_raise(TypeError) { RubyDate.ordinal(1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.ordinal(1, 1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.commercial(o) }
    assert_raise(TypeError) { RubyDate.commercial(1, o) }
    assert_raise(TypeError) { RubyDate.commercial(1, 1, o) }
    assert_raise(TypeError) { RubyDate.commercial(1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.commercial(1, 1, 1, 1, o) }
    assert_raise(TypeError) { RubyDate.commercial(1, 1, 1, 1, 1, o) }
  end
  ...
  def test_ordinal
    ...
    d = RubyDate.ordinal(-4712,1, 0,0,0, 0)
    assert_equal([-4712, 1, 1, 0, 0, 0, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.ordinal(-4712,1, 0,0,0, '+0900')
    assert_equal([-4712, 1, 1, 0, 0, 0, 9.to_r/24],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
  end
  ...
  def test_ordinal__neg
    ...
    d = RubyDate.ordinal(-1,-1, -1,-1,-1, 0)
  ...
  def test_ordinal__ex
    ...
    assert_raise(RubyDate::Error) do
      RubyDate.ordinal(2001,365, 23,59,60, 0)
    end
  end
  ...
  def test_civil
    ...
    d = RubyDate.civil(-4712,1,1, 0,0,0, 0)
    assert_equal([-4712, 1, 1, 0, 0, 0, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.civil(-4712,1,1, 0,0,0, '+0900')
    assert_equal([-4712, 1, 1, 0, 0, 0, 9.to_r/24],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])


    d = RubyDate.civil(2001,2,3 + 1.to_r/2)
    assert_equal([2001, 2, 3, 12, 0, 0, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.civil(2001,2,3, 4 + 1.to_r/2)
    assert_equal([2001, 2, 3, 4, 30, 0, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.civil(2001,2,3, 4,5 + 1.to_r/2)
    assert_equal([2001, 2, 3, 4, 5, 30, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.civil(2001,2,3, 4,5,6 + 1.to_r/2)
    assert_equal([2001, 2, 3, 4, 5, 6, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    assert_equal(1.to_r/2, d.sec_fraction)

    d = RubyDate.civil(2001, 2)
  ...
  def test_civil__neg
    ...
    d = RubyDate.civil(-1,-1,-1, -1,-1,-1, 0)
  ...
  def test_civil__ex
    ...
    assert_raise(RubyDate::Error) do
      RubyDate.civil(2001,2,28, 23,59,60, 0)
    end
    assert_raise(RubyDate::Error) do
      RubyDate.civil(2001,2,28, 24,59,59, 0)
    end
  end

  def test_civil__reform
    d = RubyDate.jd(RubyDate::ENGLAND, RubyDate::ENGLAND)
    dt = RubyDate.jd(RubyDate::ENGLAND, 0,0,0,0, RubyDate::ENGLAND)
    ...
    dt = RubyDate.jd(RubyDate::ITALY, 0,0,0,0, RubyDate::ITALY)
  ...
  def test_commercial
    ...
    dt = RubyDate.commercial
    assert_equal([-4712, 1, 1], [d.year, d.mon, d.mday])
    assert_equal([-4712, 1, 1], [dt.year, dt.mon, dt.mday])
    assert_equal([0, 0, 0], [dt.hour, dt.min, dt.sec])

    d2 = RubyDate.commercial
    dt2 = RubyDate.commercial
    assert_equal(d, d2)
    assert_equal(dt, dt2)
    ...
    d = RubyDate.commercial(1582,40,5, 0,0,0, 0)
    assert_equal([1582, 10, 15, 0, 0, 0, 0],
		 [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = RubyDate.commercial(1582,40,5, 0,0,0, '+0900')
  ...
  def test_commercial__neg
    ...
    d = RubyDate.commercial(1998,-1,-1, -1,-1,-1, 0)
  ...
  def test_commercial__ex
    ...
    assert_raise(RubyDate::Error) do
      RubyDate.commercial(1997,52,1, 23,59,60, 0)
    end
  end
  ...
  def test_weeknum
    ...
    d = RubyDate.weeknum(2002,11,4, 0, 11,22,33)
    assert_equal(2452355, d.jd)
  ...
  def test_nth_kday
    ...
    d = RubyDate.nth_kday(1992,2, 5,6, 11,22,33)
    assert_equal(2448682, d.jd)
    assert_equal([11,22,33], [d.hour, d.min, d.sec])
  ...
  def test_today
    ...
    assert_equal(false, RubyDate.respond_to?(:today))
  end
