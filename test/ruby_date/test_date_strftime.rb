...
class RubyDateDateStrftimeTest < Test::Unit::TestCase
  ...
  def test_strftime__3_1
    (RubyDate.new(1970,1,1)..RubyDate.new(2037,12,31)).each do |d|
  ...
  def test__different_format
    ...
    assert_equal('M06.01.01', RubyDate.parse('1873-01-01').jisx0301)
    assert_equal('M45.07.29', RubyDate.parse('1912-07-29').jisx0301)
    assert_equal('T01.07.30', RubyDate.parse('1912-07-30').jisx0301)
    assert_equal('T15.12.24', RubyDate.parse('1926-12-24').jisx0301)
    assert_equal('S01.12.25', RubyDate.parse('1926-12-25').jisx0301)
    assert_equal('S64.01.07', RubyDate.parse('1989-01-07').jisx0301)
    assert_equal('H01.01.08', RubyDate.parse('1989-01-08').jisx0301)
    assert_equal('H18.09.01', RubyDate.parse('2006-09-01').jisx0301)
    ...
    %w(M06.01.01
      ...
      assert_equal(s, RubyDate.parse(s).jisx0301)
    end
