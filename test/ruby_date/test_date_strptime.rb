...
class RubyDateDateStrptimeTest < Test::Unit::TestCase
  ...
  def test__strptime__2
    ...
    assert_equal({:leftover=>'x'}, RubyDate._strptime("\nx", "\n"))
    assert_equal({}, RubyDate._strptime('', "\s"*3))
    assert_equal({}, RubyDate._strptime("\s"*3, "\s"*3))
    assert_equal({}, RubyDate._strptime("\tfoo\n\000\r", "\tfoo\n\000\r"))
    assert_equal({}, RubyDate._strptime("foo\n\nbar", "foo\sbar"))
    assert_equal({}, RubyDate._strptime("%\n", "%\n")) # gnu
    assert_equal({}, RubyDate._strptime('%%', '%%%'))
    assert_equal({:wday=>6}, RubyDate._strptime('Saturday'*1024 + ',', '%A'*1024 + ','))
    assert_equal({:wday=>6}, RubyDate._strptime('Saturday'*1024 + ',', '%a'*1024 + ','))
    assert_equal({}, RubyDate._strptime('Anton von Webern', 'Anton von Webern'))
  end
  ...
  def test__strptime__fail
    assert_not_nil(RubyDate._strptime('2001.', '%Y.'))
    assert_not_nil(RubyDate._strptime("2001.\s", '%Y.'))
    assert_not_nil(RubyDate._strptime('2001.', "%Y.\s"))
    assert_not_nil(RubyDate._strptime("2001.\s", "%Y.\s"))

    assert_nil(RubyDate._strptime('2001', '%Y.'))
    assert_nil(RubyDate._strptime("2001\s", '%Y.'))
    assert_nil(RubyDate._strptime('2001', "%Y.\s"))
    assert_nil(RubyDate._strptime("2001\s", "%Y.\s"))

    assert_nil(RubyDate._strptime('2001-13-31', '%Y-%m-%d'))
    assert_nil(RubyDate._strptime('2001-12-00', '%Y-%m-%d'))
    assert_nil(RubyDate._strptime('2001-12-32', '%Y-%m-%d'))
    assert_nil(RubyDate._strptime('2001-12-00', '%Y-%m-%e'))
    assert_nil(RubyDate._strptime('2001-12-32', '%Y-%m-%e'))
    assert_nil(RubyDate._strptime('2001-12-31', '%y-%m-%d'))

    assert_nil(RubyDate._strptime('2004-000', '%Y-%j'))
    assert_nil(RubyDate._strptime('2004-367', '%Y-%j'))
    assert_nil(RubyDate._strptime('2004-366', '%y-%j'))

    assert_not_nil(RubyDate._strptime('24:59:59', '%H:%M:%S'))
    assert_not_nil(RubyDate._strptime('24:59:59', '%k:%M:%S'))
    assert_not_nil(RubyDate._strptime('24:59:60', '%H:%M:%S'))
    assert_not_nil(RubyDate._strptime('24:59:60', '%k:%M:%S'))

    assert_nil(RubyDate._strptime('24:60:59', '%H:%M:%S'))
    assert_nil(RubyDate._strptime('24:60:59', '%k:%M:%S'))
    assert_nil(RubyDate._strptime('24:59:61', '%H:%M:%S'))
    assert_nil(RubyDate._strptime('24:59:61', '%k:%M:%S'))
    assert_nil(RubyDate._strptime('00:59:59', '%I:%M:%S'))
    assert_nil(RubyDate._strptime('13:59:59', '%I:%M:%S'))
    assert_nil(RubyDate._strptime('00:59:59', '%l:%M:%S'))
    assert_nil(RubyDate._strptime('13:59:59', '%l:%M:%S'))

    assert_not_nil(RubyDate._strptime('0', '%U'))
    assert_nil(RubyDate._strptime('54', '%U'))
    assert_not_nil(RubyDate._strptime('0', '%W'))
    assert_nil(RubyDate._strptime('54', '%W'))
    assert_nil(RubyDate._strptime('0', '%V'))
    assert_nil(RubyDate._strptime('54', '%V'))
    assert_nil(RubyDate._strptime('0', '%u'))
    assert_not_nil(RubyDate._strptime('7', '%u'))
    assert_not_nil(RubyDate._strptime('0', '%w'))
    assert_nil(RubyDate._strptime('7', '%w'))

    assert_nil(RubyDate._strptime('Sanday', '%A'))
    assert_nil(RubyDate._strptime('Jenuary', '%B'))
    assert_not_nil(RubyDate._strptime('Sundai', '%A'))
    assert_not_nil(RubyDate._strptime('Januari', '%B'))
    assert_nil(RubyDate._strptime('Sundai,', '%A,'))
    assert_nil(RubyDate._strptime('Januari,', '%B,'))

    assert_nil(RubyDate._strptime('+24:00', '%Z')[:offset])
    assert_nil(RubyDate._strptime('+23:60', '%Z')[:offset])
    assert_nil(RubyDate._strptime('+23:00:60', '%Z')[:offset])
    assert_nil(RubyDate._strptime('+23:00:60', '%Z')[:offset])
  end

  def test_strptime
    assert_equal(RubyDate.new, RubyDate.strptime)
  ...
  def test_strptime__2
    (RubyDate.new(2006,6,1)..RubyDate.new(2007,6,1)).each do |d|
      [
       '%Y %m %d',
       '%C %y %m %d',
  ...
  def test_strptime__ex
    ...
    assert_raise(RubyDate::Error) do
      RubyDate.strptime('01-31-2011', '%m/%d/%Y')
    end
  end
  ...
  def test_given_string
    ...
    assert_not_equal({}, RubyDate._strptime(s, '%FT%T%Z'))
    assert_equal(s0, s)
  end
