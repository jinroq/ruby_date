...
class RubyDateDateConvTest < Test::Unit::TestCase
  def with_tz(tz)
    old = ENV["TZ"]
    begin
      ENV["TZ"] = tz
  ...
  def test_to_class
    [Time.now, RubyDate.today, RubyDate.now].each do |o|
      assert_instance_of(Time, o.to_time)
      assert_instance_of(RubyDate, o.to_date)
      assert_instance_of(RubyDate, o.to_datetime)
    end
  end
  ...
  def test_to_time__from_datetime
    d = RubyDate.new(2004, 9, 19, 1, 2, 3, 8.to_r/24) + 456789.to_r/86400000000
    t = d.to_time
    assert_equal([2004, 9, 19, 1, 2, 3, 456789, 8*60*60],
     [t.year, t.mon, t.mday, t.hour, t.min, t.sec, t.usec, t.utc_offset])

    d = RubyDate.new(2004, 9, 19, 1, 2, 3, 0) + 456789.to_r/86400000000
    t = d.to_time.utc
    assert_equal([2004, 9, 19, 1, 2, 3, 456789],
		 [t.year, t.mon, t.mday, t.hour, t.min, t.sec, t.usec])

    d = RubyDate.new(1582, 10, 3, 1, 2, 3, 0) + 456789.to_r/86400000000
    t = d.to_time.utc
    assert_equal([1582, 10, 13, 1, 2, 3, 456789],
		 [t.year, t.mon, t.mday, t.hour, t.min, t.sec, t.usec])

    d = RubyDate.new(2004, 9, 19, 1, 2, 3, 0) + 456789123.to_r/86400000000000
    t = d.to_time.utc
    ...
    unless RUBY_ENGINE == 'truffleruby'
      d = RubyDate.new(2004, 9, 19, 1, 2, 3, 0) + 456789123456789123.to_r/86400000000000000000000
      t = d.to_time.utc
  ...
  def test_to_date__from_datetime
    d = RubyDate.new(2004, 9, 19, 1, 2, 3, 9.to_r/24) + 456789.to_r/86400000000
    d2 = d.to_date
