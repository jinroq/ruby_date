...
class RubyDateDateParseTest < Test::Unit::TestCase
  ...
  def test__parse
	...
	a[2] = h[:yday]
      ...
      assert_equal(y, a, l)
      if y[6]
        h = RubyDate._parse(x[0].dup, *x[1..-1])
  ...
  def test__parse__2
    ...
    assert_raise(TypeError) {RubyDate._parse(nil)}
  end
  ...
  def test__parse_too_long_year
    ...
    unless RUBY_ENGINE == 'truffleruby'
      str = "Jan 1" + "0" * 100_000
      h = EnvUtil.timeout(3) {RubyDate._parse(str, limit: 100_010)}
  ...
  def test__iso8601
    ...
    h = RubyDate._iso8601(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._iso8601('01-02-03T04:05:06Z'.to_sym)}
  end
  ...
  def test__rfc3339
    ...
    h = RubyDate._rfc3339(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._rfc3339('2001-02-03T04:05:06Z'.to_sym)}
  end
  ...
  def test__xmlschema
    ...
    h = RubyDate._xmlschema(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._xmlschema('2001-02-03'.to_sym)}
  end
  ...
  def test__rfc2822
    ...
    h = RubyDate._rfc2822(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._rfc2822('Sat, 3 Feb 2001 04:05:06 UT'.to_sym)}
  end
  ...
  def test__httpdate
    ...
    h = RubyDate._httpdate(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._httpdate('Sat, 03 Feb 2001 04:05:06 GMT'.to_sym)}
  end
  ...
  def test__jisx0301
    ...
    h = RubyDate._jisx0301(nil)
    assert_equal({}, h)

    assert_raise(TypeError) {RubyDate._jisx0301('H13.02.03T04:05:06.07+0100'.to_sym)}
  end
  ...
  def test_jisx0301
    ...
    d = RubyDate.jisx0301('H31.04.30', RubyDate::ITALY + 10)
    assert_equal(RubyDate.new(2019,4,30), d)
    assert_equal(RubyDate::ITALY + 10, d.start)

    d = RubyDate.jisx0301('H31.05.01', RubyDate::ITALY + 10)
    assert_equal(RubyDate.new(2019,5,1), d)
    assert_equal(RubyDate::ITALY + 10, d.start)

    d = RubyDate.jisx0301('R01.05.01', RubyDate::ITALY + 10)
    assert_equal(RubyDate.new(2019,5,1), d)
    assert_equal(RubyDate::ITALY + 10, d.start)
  ...
  def test_given_string
    ...
    assert_not_equal({}, RubyDate._parse(s))
    assert_equal(s0, s)

    assert_not_equal({}, RubyDate._iso8601(s))
    assert_equal(s0, s)

    assert_not_equal({}, RubyDate._rfc3339(s))
    assert_equal(s0, s)

    assert_not_equal({}, RubyDate._xmlschema(s))
    assert_equal(s0, s)

    s = 'Sat, 3 Feb 2001 04:05:06 UT'
    s0 = s.dup
    assert_not_equal({}, RubyDate._rfc2822(s))
    assert_equal(s0, s)
    assert_not_equal({}, RubyDate._rfc822(s))
    assert_equal(s0, s)

    s = 'Sat, 03 Feb 2001 04:05:06 GMT'
    s0 = s.dup
    assert_not_equal({}, RubyDate._httpdate(s))
    assert_equal(s0, s)

    s = 'H13.02.03T04:05:06,07Z'
    s0 = s.dup
    assert_not_equal({}, RubyDate._jisx0301(s))
    assert_equal(s0, s)
  ...
  def test_length_limit
    assert_raise(ArgumentError) { RubyDate._parse("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._iso8601("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._rfc3339("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._xmlschema("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._rfc2822("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._rfc822("1" * 1000) }
    assert_raise(ArgumentError) { RubyDate._jisx0301("1" * 1000) }
  ...
  def test_string_argument
    ...
    all_assertions_foreach(nil, :_parse, :_iso8601, :_rfc3339, :_xmlschema) do |m|
      obj.count = 0
      assert_not_equal({}, RubyDate.__send__(m, obj))
