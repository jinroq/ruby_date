...
class RubyDateTest < Test::Unit::TestCase
  ...
  sub_test_case "RubyDate#<<" do
    ...
    test "goes back multiple months" do
      d = RubyDate.new(2001, 4, 15)
      d2 = d << 3
    ...
    test "advances with negative value" do
      d = RubyDate.new(2001, 1, 15)
      d2 = d << -1
    ...
    test "advances across year boundary with negative" do
      d = RubyDate.new(2001, 11, 15)
      d2 = d << -3
    ...
    test "going back 12 months equals one year" do
      d = RubyDate.new(2002, 2, 15)
      d2 = d << 12
    ...
    test "preserves start value" do
      d = RubyDate.new(2001, 2, 15, RubyDate::JULIAN)
      d2 = d << 1
    ...
    test "chained << differs from single <<" do
      d0 = RubyDate.new(2001, 3, 31)
      d1 = d0 << 2
      d2 = d0 << 1 << 1

      # d0 << 2 goes directly to January 31
      assert_equal(1, d1.month)
      assert_equal(31, d1.day)

      # d0 << 1 << 1 goes to Feb 28, then Jan 28
      assert_equal(1, d2.month)
      assert_equal(28, d2.day)
    end
  end
  ...
  # RubyDate#next_day tests
  sub_test_case "RubyDate#next_day" do
    test "returns next day by default" do
      d = RubyDate.new(2001, 2, 3)
      d2 = d.next_day
  ...
  # RubyDate#prev_day tests
  sub_test_case "RubyDate#prev_day" do
    test "returns previous day by default" do
      d = RubyDate.new(2001, 2, 3)
      d2 = d.prev_day
    ...
    test "returns n days earlier" do
      d = RubyDate.new(2001, 2, 8)
      d2 = d.prev_day(5)
    ...
    test "crosses month boundary backward" do
  ...
  # RubyDate#next tests
  sub_test_case "RubyDate#next" do
    test "returns next day" do
      d = RubyDate.new(2001, 2, 3)
      d2 = d.next
  ...
  # RubyDate#succ tests
  sub_test_case "RubyDate#succ" do
    test "is alias for next" do
      d = RubyDate.new(2001, 2, 3)

      assert_equal(d.next, d.succ)
    end
